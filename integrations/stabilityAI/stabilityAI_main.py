    ...
    def text_to_image(self,payload_data):
        try:
            ...
            if response.status_code!=200:
                raise StabilityAIException(id=response_dict['id'],message=response_dict['message'],name=[response_dict['name']])
            return response_dict
        except Exception as e:
            print("Exception occured in class StabilityAI : text_to_image ",describe_exception(e))
            raise e
