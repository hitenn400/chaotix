...
class StabilityAIWrapper:
    ...
    def generate_image_from_text(self,image_text_ai_id):
        try:
            ...
            try:
                text_to_image_res = stability_ai.text_to_image(payload_data=text_to_image_api_payload)
            ...
            raise Exception("TextToImageAI does not exist with given id: ",image_text_ai_id)
